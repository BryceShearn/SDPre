    ...
    num2 = kb.nextDouble();
                ...
                while (keepGoing) {
                       ...
                       case 1:
                         ...
                         System.out.println(+ num1 + " + " + num2 +" = " + sum); //line 65
                         break;

                       case 2:
                         double average = findAverage(num1, num2);
                         System.out.println("The average of " + num1 + " and " + num2 + " is: " + average); //line 67
                         break;

                       case 3:
                         double tax = calcTax(num1, num2);
                         System.out.println("The amount in tax to be collected from a purchase of " + num1 + " and " + num2 + " is: " + tax); //71
                         break;
